...
function attendanceSetDailyBoss() {
	var day=document.getElementById("day").value;
	
	
	var url="/company/servlet/AttendanceAddB";
	var params="day="+day;
	//alert(params);
	$.ajax({
		type:'POST',
...
function attendanceShowDailyBoss() {
	var day=document.getElementById("day").value;
	
	
	var url="/company/servlet/AttendanceShowDeptMngB";
	var params="day="+day;
	//alert(params);
	$.ajax({
		type:'POST',
...
function getRecordListByDayBoss() {
	var url="/company/servlet/AttendanceRecordListByDayB";
...
function getRecordListByEidBoss() {
	
	var url="/company/servlet/AttendanceRecordListByEidB";
...
function getListByDayBoss() {
	var url="/company/servlet/AttendanceListByDayB";
...
function getListByEidBoss() {
	...
	var url="/company/servlet/AttendanceListByEidB";
...
function getAttendanceCountMonthlyBoss(){
	
	var url="/company/servlet/AttendanceCountMonthlyB";
