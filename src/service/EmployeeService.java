...
public class EmployeeService {
	...
	public Employee login(int eid, String password) {
		// EmployeeDao.findByEid(eid)根据输入的eid查找员工
	...
	public int add(int eid, String name, String gender, String email,
			...
			int isQuit, String password, List<String> skills,
			List<String> trainings) {
		int result = ed.add(eid, name, gender, email, tel, enrollTime, level,
				department, isQuit, password);
